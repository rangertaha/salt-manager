...
from  webapp.apps.accounts.registration.views import activate
from  webapp.apps.accounts.registration.views import register
...
urlpatterns = patterns('',
                       ...
                       url(r'^activate-with-template-name/(?P<activation_key>\w+)/$',
                           ...
                           {'template_name': 'registration/test_template_name.html',
                            'backend': ' webapp.apps.accounts.registration.backends.default.DefaultBackend'},
                       ...
                       (r'', include(' webapp.apps.accounts.registration.backends.default.urls')),
                       )
